...
## Question 2 (a)
1) To import the three JSON files into MongoDB databse, first download the [Analytics dataset](https://github.com/drshahizan/dataset/tree/main/mongodb/02-analytics).
