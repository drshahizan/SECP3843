...
urlpatterns = [
    ...
    path('accounts/login/', views.CustomLoginView.as_view(), name='login'),  # Updated login URL pattern
    ...
    path('dashboard/management/', views.management_dashboard_view, name='management_dashboard'),
]
